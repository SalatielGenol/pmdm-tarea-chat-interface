...
private val anakin = ChatData(userName = "Anakin Skywalker")
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!firstRun) {
            ...
            anakin.addMessage(
                messageText = "si, si ya he dicho que cualquier gatito me encanta, simplemente es por el caracter del gato, y cuanto tiempo crees que debo tener a un gatito conmigo para acostumbrarlo a la casa y a mi?",
                isFromSender = true
            )
            ...
            anakin.addMessage(
                messageText = "Hombre, podría adoptar uno con un año o asi, no me importaría... no quiero que por un capricho de que sea un cachorro, el lo pase mal solo 10 horas al dia.",
                isFromSender = true
            )
            firstRun = true
        }
